...
const categoryData = [
  ...
  { id: 'fairway', label: 'Fairway', icon: Target },
  { id: 'gir', label: 'GIR', icon: Target },
...
const categoryColors: Record<string, string> = {
  ...
  fairway: 'border-l-emerald-600 bg-emerald-100/80 dark:bg-emerald-900/30',
  gir: 'border-l-green-600 bg-green-100/80 dark:bg-green-900/30',
