...
const courseHoleData: Record<string, number[]> = {
  "The Montgomerie Marrakech": [4, 4, 5, 3, 4, 4, 4, 3, 4, 4, 3, 4, 5, 4, 4, 3, 4, 5], // Par 70
  "Royal Golf Dar Es Salam": [4, 5, 3, 4, 5, 3, 4, 4, 4, 4, 4, 5, 3, 4, 5, 3, 4, 4], // Par 72
  ...
  "Royal Golf Marrakech": [4, 4, 3, 4, 5, 3, 4, 4, 4, 4, 5, 3, 4, 4, 5, 3, 4, 4], // Par 71
...
const moroccoGolfCourses = [
  ...
  },
  {
    ...
    longitude: -9.6865,
    totalHoles: 18,
    description: "A spectacular clifftop course designed by Kyle Phillips, offering breathtaking Atlantic Ocean views from every hole.",
  ...
  },
  {
    ...
    longitude: -8.0463,
    totalHoles: 18,
    description: "An exclusive 18-hole championship course set in 75 hectares of natural space with Atlas Mountains backdrop.",
  ...
  },
  {
    ...
    longitude: -8.0604,
    totalHoles: 18,
    description: "A world-class course designed by Nicklaus Design, featuring long fairways and strategic challenges.",
  ...
  },
  {
    ...
    longitude: -7.9555,
    totalHoles: 18,
    description: "A beautiful resort course set over 150 hectares surrounded by olive and palm trees.",
  ...
  },
  {
    ...
    longitude: -5.1585,
    totalHoles: 18,
    description: "Morocco's highest golf course at 1,650m altitude in the Middle Atlas Mountains. Designed by Jack Nicklaus.",
  ...
  },
  {
    ...
    longitude: -7.9376,
    totalHoles: 18,
    description: "A championship course facing the Atlas Mountains with wooded smooth curves.",
  ...
  },
  {
    ...
    longitude: -9.5601,
    totalHoles: 27,
    description: "A 27-hole championship course designed by Cabell B. Robinson.",
    designer: "Cabell B. Robinson",
    yearBuilt: 1991,
  ...
  },
  {
    ...
    longitude: -4.9890,
    totalHoles: 18,
    description: "A beautiful course set in a vast olive grove at 700m altitude.",
  ...
  },
  {
    ...
    longitude: -8.0098,
    totalHoles: 18,
    description: "An 18-hole course designed by golf legend Colin Montgomerie.",
  ...
  },
  {
    ...
    longitude: -9.5312,
    totalHoles: 9,
    description: "One of Morocco's oldest golf courses, surrounded by rose walls and lush gardens.",
    designer: "Unknown",
    yearBuilt: 1956,
  ...
  },
  {
    ...
    longitude: -5.8892,
    totalHoles: 18,
    description: "A magnificent 18-hole course plus a compact 9-hole floodlit course.",
    designer: "Robert Trent Jones Sr.",
    yearBuilt: 2017,
  ...
  },
  {
    ...
    longitude: -5.5547,
    totalHoles: 9,
    description: "A charming 9-hole course set within the gardens of the Royal Palace in Meknes.",
    designer: "Unknown",
    yearBuilt: 1970,
  ...
  },
  {
    ...
    longitude: -7.9340,
    totalHoles: 27,
    description: "One of Morocco's most selective golf layouts with technical difficulties.",
    designer: "C. Robinson",
    yearBuilt: 1995,
  ...
  },
  {
    ...
    longitude: -5.8234,
    totalHoles: 18,
    description: "A historic course with stunning views of the Strait of Gibraltar.",
    designer: "M. Rimet",
    yearBuilt: 1914,
  ...
  },
  {
    ...
    longitude: -7.9678,
    totalHoles: 18,
    description: "An 18-hole course set in the famous Palmeraie of Marrakech.",
    designer: "Robert Trent Jones Sr.",
    yearBuilt: 1993,
  ...
  },
  {
    ...
    longitude: -9.7823,
    totalHoles: 18,
    description: "A spectacular links-style course designed by Gary Player on the Atlantic coast.",
    designer: "Gary Player",
    yearBuilt: 2009,
  ...
  },
  {
    ...
    longitude: -8.0456,
    totalHoles: 18,
    description: "A contemporary course with minimalist design inspired by the local landscape.",
  ...
  },
  {
    ...
    longitude: -7.9891,
    totalHoles: 9,
    description: "A compact 9-hole course perfect for beginners and practice.",
  ...
  },
  {
    ...
    longitude: -7.0987,
    totalHoles: 18,
    description: "A challenging course set in a pine forest between Casablanca and Rabat.",
...
function generateTees(): { name: string; color: string; rating: number; slope: number }[] {
  return [
...
async function main() {
  console.log('Seeding Morocco golf courses (upsert mode - preserves existing data)...');
  ...
  console.log(`Total courses in seed file: ${moroccoGolfCourses.length}`);
}
